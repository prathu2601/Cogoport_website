...
import Cartoor_image from './video/cogoport-subscribe.webp'

function Subscribe() {
  return (
    <div className='Conbained_main'>
        <div className='Subscribe_main'>
            <div className='Subscribe_container'>
                <img src={Cartoor_image}/>
            </div>
        ...
        <div className='Content_main'>
            <div className='Content_column'>
                <ul>
                    <li className='Content_deco'>Products</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
            ...
            <div className='Content_column'>
                <ul>
                    <li className='Content_deco'>Tools</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
            ...
            <div className='Content_column'>
                <ul>
                    <li className='Content_deco'>Company</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
            ...
            <div className='Content_column'>
                <ul>
                    <li className='Content_deco'>Knowledge Center</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
            ...
            <div className='Content_column'>
                <ul>
                    <li className='Content_deco'>Contact Us</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
                    <li>dasdsa</li>
